...
const EliminarClienteModal = ({ isOpen, onClose, onConfirm, clienteNombre }) => {
      ...
      >
        ...
        <div className="p-6">
          <p className="text-gray-700">
            ¿Estás seguro de que deseas eliminar al cliente <strong>{clienteNombre}</strong>? Esta acción no se puede deshacer.
          </p>
        </div>
