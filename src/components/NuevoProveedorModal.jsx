...
const NuevoProveedorModal = ({ isOpen, onClose }) => {
  const { addProveedor } = useProveedor();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Crear el objeto del proveedor con la fecha de creación automática
      const proveedorNuevo = {
        ...formData,
        fecha_creacion: new Date(), // Fecha actual automática
      };

      // Llamar a la función del contexto para añadir el proveedor
      await addProveedor(proveedorNuevo);
