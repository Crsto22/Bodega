...
const EditarProductoModal = ({ isOpen, onClose, producto }) => {
  const { editProduct } = useProduct(); // Función para editar el producto
  ...
  // Prellenar el formulario con los datos del producto al abrir el modal
  useEffect(() => {
    if (producto) {
      setFormData({
      ...
      setTieneMarca(!!producto.marca); // Activar el toggle de marca si el producto tiene marca
      setTieneFechaVencimiento(!!producto.fecha_vencimiento); // Activar el toggle de fecha de vencimiento si el producto tiene fecha
      setCategoriaSeleccionada(producto.categoria || ''); // Establecer la categoría seleccionada
    }
  }, [producto]);
  ...
  const handleCategoriaChange = (e) => {
    ...
    setFormData({
      ...formData,
      categoria,
      stock: categoriasEspeciales.includes(categoria) ? 'No Especificado' : formData.stock,
    });
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Llamar a la función del contexto para editar el producto
      await editProduct(producto.id, productoEditado);
              ...
              <div className="col-span-full">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <option value="Alimentos a Granel">Alimentos a Granel</option>
